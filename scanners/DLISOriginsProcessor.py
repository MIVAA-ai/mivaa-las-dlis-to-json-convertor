...
class DLISOriginsProcessor:
    ...
    def extract_origins(self):
        ...
        #     print(f"No origins found for logical file: {self._logical_file_id}")
        #     return pd.DataFrame()
    ...
    def map_headers(self, origins_df):
        ...
        try:
            ...
            for key, fields in header_mapping.items():
                header[key] = self._get_first_matching_value(fields, origins_df)
            ...
            # Add unmapped fields
            self._add_unmapped_fields(header, header_mapping, origins_df)
    ...
    def _get_first_matching_value(self, fields, origins_df):
        """
    ...
    def _add_unmapped_fields(self, header, header_mapping, origins_df):
        """
